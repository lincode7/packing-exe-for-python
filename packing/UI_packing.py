...
# Form implementation generated from reading ui file 'UI_packing.ui'
#
...
"}")
        ...
        self.icon = QtWidgets.QTextEdit(self.centralwidget)
        ...
        self.resources = QtWidgets.QTextEdit(self.centralwidget)
        self.resources.setAcceptDrops(True)
        self.resources.setAutoFormatting(QtWidgets.QTextEdit.AutoBulletList)
        ...
        self.checkBox_i.setTristate(False)
        self.checkBox_i.setObjectName("checkBox_i")
        self.horizontalLayout_2.addWidget(self.checkBox_i)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.icon.setPlaceholderText(_translate("MainWindow", "此处放置图标文件"))
        ...
        self.resources.setPlaceholderText(_translate("MainWindow", "此处放置额外资源文件"))
        ...
        self.checkBox_i.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-family:\'-apple-system\',\'BlinkMacSystemFont\',\'Apple Color Emoji\',\'Segoe UI Emoji\',\'Segoe UI Symbol\',\'Segoe UI\',\'PingFang SC\',\'Hiragino Sans GB\',\'Microsoft YaHei\',\'Helvetica Neue\',\'Helvetica\',\'Arial\',\'sans-serif\'; font-size:9pt; color:#404040; background-color:rgba(179,179,179,0.14902);\">设置exe文件的图标，只支持ico文件</span></p></body></html>"))
